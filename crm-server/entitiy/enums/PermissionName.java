...
public enum PermissionName {
    ...
    GET_REPORT("Reportlarni olish",GroupName.REPORT_CRUD),
    ADD_REPORT("Report qo'shish",GroupName.REPORT_CRUD),
    EDIT_REPORT("Report taxrirlash",GroupName.REPORT_CRUD),
    DELETE_REPORT("Report o'chirish",GroupName.REPORT_CRUD),
    GET_ONE_REPORT("Reportni olish",GroupName.REPORT_CRUD),
    GET_TRANSFER("Transferlarni olish",GroupName.TRANSFER_CRUD),
    ADD_TRANSFER("Transfer qo'shish",GroupName.TRANSFER_CRUD),
    EDIT_TRANSFER("Transfer taxrirlash",GroupName.TRANSFER_CRUD),
    DELETE_TRANSFER("Transfer o'chirish",GroupName.TRANSFER_CRUD),
